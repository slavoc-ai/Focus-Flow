        ...
        {!isPremium && (
          <div className="mt-2 pt-2 border-t border-border">
            <p className="text-xs text-muted-foreground">
              💎 <strong>Upgrade to Premium</strong> for TUS resumable uploads, files up to {MAX_PREMIUM_INDIVIDUAL_MB}MB, up to {MAX_PREMIUM_FILES} files, and priority processing.
            </p>
          </div>
        )}
      </div>
